...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Srisanjay M — Software Engineer & Full Stack Developer" },
      ...
      { property: "og:image", content: "https://srisanjay-portfolio.vercel.app/projects/home-preview.png" },
      { property: "og:url", content: "https://srisanjay-portfolio.vercel.app/" },
      { name: "twitter:image", content: "https://srisanjay-portfolio.vercel.app/projects/home-preview.png" },
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="en">
      <head>
        <meta name="google-site-verification" content="GZ5V5b1ElvQWGIqZePfBhCL-DmdFspIbM38oW3utXI0" />
        <HeadContent />
      </head>
      <body>
        {children}
